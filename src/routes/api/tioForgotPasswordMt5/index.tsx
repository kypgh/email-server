...
import zod from "zod";
import TIO_forgotMt5AccountPassword from "emails/TIO_forgotMt5AccountPasswordEmailData";
...
export const GET: RouteHandler = async (req, res) => {
  ...
  let subject = `${data.tioForgotPasswordMt5.subject} (${values.accountNumber}) (${timeNow})`;
  ...
  await sendEmail(
    TIO_forgotMt5AccountPassword({
      params,
      content: data.tioForgotPasswordMt5,
